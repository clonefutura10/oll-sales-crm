      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-20'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12'>
            We&apos;re crafting competitive pricing plans that deliver
            exceptional value. Stay tuned for flexible options designed to fit
            teams of all sizes.
          </p>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16'>
            <div className='bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left border-2 border-gray-200 dark:border-gray-700'>
              ...
              <ul className='space-y-2 text-sm text-gray-600 dark:text-gray-400'>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Up to 5
                  users
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Basic CRM
                  features
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> 1GB storage
                </li>
              </ul>
            </div>
            <div className='bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 text-left border-2 border-blue-500 relative'>
              ...
              <ul className='space-y-2 text-sm text-gray-600 dark:text-gray-400'>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Up to 25
                  users
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Advanced
                  analytics
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> 10GB storage
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Priority
                  support
                </li>
              </ul>
            </div>
            <div className='bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left border-2 border-gray-200 dark:border-gray-700'>
              ...
              <ul className='space-y-2 text-sm text-gray-600 dark:text-gray-400'>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Unlimited
                  users
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Custom
                  integrations
                </li>
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Unlimited
                ...
                <li className='flex items-center'>
                  <Star className='w-4 h-4 mr-2 text-yellow-500' /> Dedicated
                  support
                </li>
              </ul>
            </div>
