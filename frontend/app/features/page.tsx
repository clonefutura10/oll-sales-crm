      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12">
            We&apos;re building powerful features to revolutionize your sales workflow. 
            Get ready for an amazing experience that will transform how you manage your sales process.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Smart Lead Scoring</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                AI-powered lead scoring to prioritize your most valuable prospects
              </p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left">
