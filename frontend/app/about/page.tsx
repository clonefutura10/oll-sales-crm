      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-20'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12'>
            We&apos;re preparing to share our story with you. Learn about our
            mission, values, and the passionate team behind our innovative CRM
            platform.
          </p>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16'>
            <div className='bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left'>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-sm'>
                To empower sales teams with intelligent tools that transform how
                they connect with customers and close deals.
              </p>
            </div>
            <div className='bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left'>
              <div className='flex items-center mb-4'>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-sm'>
                Innovation, customer success, and transparency drive everything
                we do. We&apos;re committed to building trust through
                exceptional service.
              </p>
            </div>
            <div className='bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-left'>
              ...
              <p className='text-gray-600 dark:text-gray-400 text-sm'>
                ...
                revolutionizing the sales industry with cutting-edge technology.
              </p>
            </div>
          </div>
              ...
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <div className='text-gray-600 dark:text-gray-400'>
                    Company founded with a vision to transform sales technology
                  </div>
                </div>
              </div>
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <div className='text-gray-600 dark:text-gray-400'>
                    Launch of our innovative CRM platform
                  </div>
                </div>
              </div>
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <div className='text-gray-600 dark:text-gray-400'>
                    Continuing to innovate and serve our customers
                  </div>
                </div>
              </div>
            </div>
