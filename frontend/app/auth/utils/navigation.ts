...
export const useAuthNavigation = () => {
   ...
   */
  const navigateToLogin = useCallback((options?: AuthNavigationOptions) => {
   ...
   */
  const navigateToSignup = useCallback((options?: AuthNavigationOptions) => {
    const { redirect, replace = true } = options || {}
   ...
   */
  const navigateToHome = useCallback((options?: AuthNavigationOptions) => {
    const { redirect, replace = true } = options || {}
